...
-- | Configures liveness health checking for VM instances. Unhealthy
...
newtype SSLSettings = SSLSettings'
...
-- application. Clearing this field will remove SSL support. Example:
-- 12345.
