...
--
-- /See:/ <https://cloud.google.com/appengine/docs/admin-api/ Google App Engine Admin API Reference> for @appengine.apps.domainMappings.create@.
module Network.Google.Resource.AppEngine.Apps.DomainMAppings.Create
    (
    -- * REST Resource
...
data AppsDomainMAppingsCreate = AppsDomainMAppingsCreate'
    ...
    , _admacBearerToken :: !(Maybe Text)
    , _admacOverrideStrategy :: !(Maybe Text)
    , _admacAppsId :: !Text
    , _admacFields :: !(Maybe Text)
...
admacPp :: Lens' AppsDomainMAppingsCreate Bool
admacPp = lens _admacPp (\ s a -> s{_admacPp = a})
...
-- | OAuth bearer token.
admacBearerToken :: Lens' AppsDomainMAppingsCreate (Maybe Text)
admacBearerToken
  = lens _admacBearerToken
      (\ s a -> s{_admacBearerToken = a})
...
admacFields :: Lens' AppsDomainMAppingsCreate (Maybe Text)
admacFields
  = lens _admacFields (\ s a -> s{_admacFields = a})
