...
--
-- /See:/ <https://cloud.google.com/appengine/docs/admin-api/ Google App Engine Admin API Reference> for @appengine.apps.domainMappings.patch@.
module Network.Google.Resource.AppEngine.Apps.DomainMAppings.Patch
    (
    -- * REST Resource
...
data AppsDomainMAppingsPatch = AppsDomainMAppingsPatch'
    ...
    , _admapBearerToken :: !(Maybe Text)
    , _admapAppsId :: !Text
    , _admapDomainMAppingsId :: !Text
    , _admapFields :: !(Maybe Text)
...
admapPp :: Lens' AppsDomainMAppingsPatch Bool
admapPp = lens _admapPp (\ s a -> s{_admapPp = a})
...
-- | OAuth bearer token.
admapBearerToken :: Lens' AppsDomainMAppingsPatch (Maybe Text)
admapBearerToken
  = lens _admapBearerToken
      (\ s a -> s{_admapBearerToken = a})
...
admapFields :: Lens' AppsDomainMAppingsPatch (Maybe Text)
admapFields
  = lens _admapFields (\ s a -> s{_admapFields = a})
