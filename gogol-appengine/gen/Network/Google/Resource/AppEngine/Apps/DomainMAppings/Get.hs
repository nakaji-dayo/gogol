...
--
-- /See:/ <https://cloud.google.com/appengine/docs/admin-api/ Google App Engine Admin API Reference> for @appengine.apps.domainMappings.get@.
module Network.Google.Resource.AppEngine.Apps.DomainMAppings.Get
    (
    -- * REST Resource
...
data AppsDomainMAppingsGet = AppsDomainMAppingsGet'
    ...
    , _admagBearerToken :: !(Maybe Text)
    , _admagAppsId :: !Text
    , _admagDomainMAppingsId :: !Text
    , _admagFields :: !(Maybe Text)
...
admagPp :: Lens' AppsDomainMAppingsGet Bool
admagPp = lens _admagPp (\ s a -> s{_admagPp = a})
...
-- | OAuth bearer token.
admagBearerToken :: Lens' AppsDomainMAppingsGet (Maybe Text)
admagBearerToken
  = lens _admagBearerToken
      (\ s a -> s{_admagBearerToken = a})
...
admagFields :: Lens' AppsDomainMAppingsGet (Maybe Text)
admagFields
  = lens _admagFields (\ s a -> s{_admagFields = a})
