...
--
-- /See:/ <https://cloud.google.com/appengine/docs/admin-api/ Google App Engine Admin API Reference> for @appengine.apps.firewall.ingressRules.get@.
module Network.Google.Resource.AppEngine.Apps.Firewall.IngressRules.Get
    (
    -- * REST Resource
...
data AppsFirewallIngressRulesGet = AppsFirewallIngressRulesGet'
    ...
    , _afirgBearerToken :: !(Maybe Text)
    , _afirgIngressRulesId :: !Text
    , _afirgAppsId :: !Text
    , _afirgFields :: !(Maybe Text)
...
afirgPp :: Lens' AppsFirewallIngressRulesGet Bool
afirgPp = lens _afirgPp (\ s a -> s{_afirgPp = a})
...
-- | OAuth bearer token.
afirgBearerToken :: Lens' AppsFirewallIngressRulesGet (Maybe Text)
afirgBearerToken
  = lens _afirgBearerToken
      (\ s a -> s{_afirgBearerToken = a})
...
afirgFields :: Lens' AppsFirewallIngressRulesGet (Maybe Text)
afirgFields
  = lens _afirgFields (\ s a -> s{_afirgFields = a})
