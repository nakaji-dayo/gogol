...
--
-- /See:/ <https://cloud.google.com/appengine/docs/admin-api/ Google App Engine Admin API Reference> for @appengine.apps.authorizedCertificates.delete@.
module Network.Google.Resource.AppEngine.Apps.AuthorizedCertificates.Delete
    (
    -- * REST Resource
...
data AppsAuthorizedCertificatesDelete = AppsAuthorizedCertificatesDelete'
    ...
    , _aacdBearerToken :: !(Maybe Text)
    , _aacdAppsId :: !Text
    , _aacdFields :: !(Maybe Text)
...
aacdPp :: Lens' AppsAuthorizedCertificatesDelete Bool
aacdPp = lens _aacdPp (\ s a -> s{_aacdPp = a})
...
-- | OAuth bearer token.
aacdBearerToken :: Lens' AppsAuthorizedCertificatesDelete (Maybe Text)
aacdBearerToken
  = lens _aacdBearerToken
      (\ s a -> s{_aacdBearerToken = a})
...
aacdFields :: Lens' AppsAuthorizedCertificatesDelete (Maybe Text)
aacdFields
  = lens _aacdFields (\ s a -> s{_aacdFields = a})
