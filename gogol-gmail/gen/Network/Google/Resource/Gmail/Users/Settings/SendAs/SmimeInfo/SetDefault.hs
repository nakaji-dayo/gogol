...
ussasisdFields :: Lens' UsersSettingsSendAsSmimeInfoSetDefault (Maybe Text)
ussasisdFields
  = lens _ussasisdFields
      (\ s a -> s{_ussasisdFields = a})
