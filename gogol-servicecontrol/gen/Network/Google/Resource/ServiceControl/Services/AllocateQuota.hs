...
--
-- /See:/ <https://cloud.google.com/service-control/ Google Service Control API Reference> for @servicecontrol.services.allocateQuota@.
module Network.Google.Resource.ServiceControl.Services.AllocateQuota
    (
    -- * REST Resource
...
data ServicesAllocateQuota = ServicesAllocateQuota'
    ...
    , _saqBearerToken :: !(Maybe Text)
    , _saqServiceName :: !Text
    , _saqFields :: !(Maybe Text)
...
saqPp :: Lens' ServicesAllocateQuota Bool
saqPp = lens _saqPp (\ s a -> s{_saqPp = a})
...
-- | OAuth bearer token.
saqBearerToken :: Lens' ServicesAllocateQuota (Maybe Text)
saqBearerToken
  = lens _saqBearerToken
      (\ s a -> s{_saqBearerToken = a})
...
saqFields :: Lens' ServicesAllocateQuota (Maybe Text)
saqFields
  = lens _saqFields (\ s a -> s{_saqFields = a})
