...
projectsUptimeCheckConfigsList pPucclParent_ = 
    ...
    , _pucclBearerToken = Nothing
    , _pucclPageToken = Nothing
    , _pucclPageSize = Nothing
    , _pucclFields = Nothing
...
pucclPp :: Lens' ProjectsUptimeCheckConfigsList Bool
pucclPp = lens _pucclPp (\ s a -> s{_pucclPp = a})
...
-- | OAuth bearer token.
pucclBearerToken :: Lens' ProjectsUptimeCheckConfigsList (Maybe Text)
pucclBearerToken
  = lens _pucclBearerToken
      (\ s a -> s{_pucclBearerToken = a})
...
pucclFields :: Lens' ProjectsUptimeCheckConfigsList (Maybe Text)
pucclFields
  = lens _pucclFields (\ s a -> s{_pucclFields = a})
