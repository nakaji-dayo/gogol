...
cPp :: Lens' CoursesAnnouncementsDelete Bool
cPp = lens _cPp (\ s a -> s{_cPp = a})
...
-- | OAuth bearer token.
cBearerToken :: Lens' CoursesAnnouncementsDelete (Maybe Text)
cBearerToken
  = lens _cBearerToken (\ s a -> s{_cBearerToken = a})
...
cFields :: Lens' CoursesAnnouncementsDelete (Maybe Text)
