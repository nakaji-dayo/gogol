...
data CoursesCourseWorkModifyAssignees = CoursesCourseWorkModifyAssignees'
    ...
    , _ccwmaBearerToken :: !(Maybe Text)
    , _ccwmaId :: !Text
    , _ccwmaFields :: !(Maybe Text)
...
coursesCourseWorkModifyAssignees pCcwmaCourseId_ pCcwmaPayload_ pCcwmaId_ = 
    ...
    , _ccwmaBearerToken = Nothing
    , _ccwmaId = pCcwmaId_
    , _ccwmaFields = Nothing
...
ccwmaPp :: Lens' CoursesCourseWorkModifyAssignees Bool
ccwmaPp = lens _ccwmaPp (\ s a -> s{_ccwmaPp = a})
...
-- | OAuth bearer token.
ccwmaBearerToken :: Lens' CoursesCourseWorkModifyAssignees (Maybe Text)
ccwmaBearerToken
  = lens _ccwmaBearerToken
      (\ s a -> s{_ccwmaBearerToken = a})
...
ccwmaFields :: Lens' CoursesCourseWorkModifyAssignees (Maybe Text)
ccwmaFields
  = lens _ccwmaFields (\ s a -> s{_ccwmaFields = a})
