...
--
-- /See:/ <https://cloud.google.com/dataflow Google Dataflow API Reference> for @dataflow.projects.locations.jobs.debug.getConfig@.
module Network.Google.Resource.Dataflow.Projects.Locations.Jobs.Debug.GetConfig
    (
    -- * REST Resource
...
data ProjectsLocationsJobsDebugGetConfig = ProjectsLocationsJobsDebugGetConfig'
    ...
    , _pljdgcBearerToken :: !(Maybe Text)
    , _pljdgcProjectId :: !Text
    , _pljdgcFields :: !(Maybe Text)
...
projectsLocationsJobsDebugGetConfig pPljdgcJobId_ pPljdgcLocation_ pPljdgcPayload_ pPljdgcProjectId_ = 
    ...
    , _pljdgcBearerToken = Nothing
    , _pljdgcProjectId = pPljdgcProjectId_
    , _pljdgcFields = Nothing
...
pljdgcPp :: Lens' ProjectsLocationsJobsDebugGetConfig Bool
pljdgcPp = lens _pljdgcPp (\ s a -> s{_pljdgcPp = a})
...
-- | OAuth bearer token.
pljdgcBearerToken :: Lens' ProjectsLocationsJobsDebugGetConfig (Maybe Text)
pljdgcBearerToken
  = lens _pljdgcBearerToken
      (\ s a -> s{_pljdgcBearerToken = a})
...
pljdgcFields :: Lens' ProjectsLocationsJobsDebugGetConfig (Maybe Text)
pljdgcFields
  = lens _pljdgcFields (\ s a -> s{_pljdgcFields = a})
