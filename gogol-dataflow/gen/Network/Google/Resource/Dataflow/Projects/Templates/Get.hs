...
--
-- /See:/ <https://cloud.google.com/dataflow Google Dataflow API Reference> for @dataflow.projects.templates.get@.
module Network.Google.Resource.Dataflow.Projects.Templates.Get
    (
    -- * REST Resource
...
ptgPp :: Lens' ProjectsTemplatesGet Bool
...
-- | OAuth bearer token.
ptgBearerToken :: Lens' ProjectsTemplatesGet (Maybe Text)
ptgBearerToken
...
ptgFields :: Lens' ProjectsTemplatesGet (Maybe Text)
ptgFields
