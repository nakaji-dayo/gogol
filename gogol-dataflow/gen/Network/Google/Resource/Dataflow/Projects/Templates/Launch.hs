...
-- Launch a template.
--
-- /See:/ <https://cloud.google.com/dataflow Google Dataflow API Reference> for @dataflow.projects.templates.launch@.
module Network.Google.Resource.Dataflow.Projects.Templates.Launch
    (
    -- * REST Resource
...
ptlPp :: Lens' ProjectsTemplatesLaunch Bool
...
-- | OAuth bearer token.
ptlBearerToken :: Lens' ProjectsTemplatesLaunch (Maybe Text)
ptlBearerToken
...
ptlFields :: Lens' ProjectsTemplatesLaunch (Maybe Text)
ptlFields
