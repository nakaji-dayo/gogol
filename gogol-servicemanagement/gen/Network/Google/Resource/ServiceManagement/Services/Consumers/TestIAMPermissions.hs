...
-- warning.
--
-- /See:/ <https://cloud.google.com/service-management/ Google Service Management API Reference> for @servicemanagement.services.consumers.testIamPermissions@.
module Network.Google.Resource.ServiceManagement.Services.Consumers.TestIAMPermissions
    (
    -- * REST Resource
...
data ServicesConsumersTestIAMPermissions = ServicesConsumersTestIAMPermissions'
    ...
    , _sctipBearerToken :: !(Maybe Text)
    , _sctipResource :: !Text
    , _sctipFields :: !(Maybe Text)
...
servicesConsumersTestIAMPermissions pSctipPayload_ pSctipResource_ = 
    ...
    , _sctipBearerToken = Nothing
    , _sctipResource = pSctipResource_
    , _sctipFields = Nothing
...
sctipPp :: Lens' ServicesConsumersTestIAMPermissions Bool
sctipPp = lens _sctipPp (\ s a -> s{_sctipPp = a})
...
-- | OAuth bearer token.
sctipBearerToken :: Lens' ServicesConsumersTestIAMPermissions (Maybe Text)
sctipBearerToken
  = lens _sctipBearerToken
      (\ s a -> s{_sctipBearerToken = a})
...
sctipFields :: Lens' ServicesConsumersTestIAMPermissions (Maybe Text)
sctipFields
  = lens _sctipFields (\ s a -> s{_sctipFields = a})
