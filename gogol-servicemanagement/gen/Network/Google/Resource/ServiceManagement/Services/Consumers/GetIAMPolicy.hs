...
--
-- /See:/ <https://cloud.google.com/service-management/ Google Service Management API Reference> for @servicemanagement.services.consumers.getIamPolicy@.
module Network.Google.Resource.ServiceManagement.Services.Consumers.GetIAMPolicy
    (
    -- * REST Resource
...
data ServicesConsumersGetIAMPolicy = ServicesConsumersGetIAMPolicy'
    ...
    , _scgipBearerToken :: !(Maybe Text)
    , _scgipResource :: !Text
    , _scgipFields :: !(Maybe Text)
...
servicesConsumersGetIAMPolicy pScgipPayload_ pScgipResource_ = 
    ...
    , _scgipBearerToken = Nothing
    , _scgipResource = pScgipResource_
    , _scgipFields = Nothing
...
scgipPp :: Lens' ServicesConsumersGetIAMPolicy Bool
scgipPp = lens _scgipPp (\ s a -> s{_scgipPp = a})
...
-- | OAuth bearer token.
scgipBearerToken :: Lens' ServicesConsumersGetIAMPolicy (Maybe Text)
scgipBearerToken
  = lens _scgipBearerToken
      (\ s a -> s{_scgipBearerToken = a})
...
scgipFields :: Lens' ServicesConsumersGetIAMPolicy (Maybe Text)
scgipFields
  = lens _scgipFields (\ s a -> s{_scgipFields = a})
