...
-- symbol \`*\`. Some example queries are: |Query|Description|
-- |------|-----------| |displayName=Test*|Folders whose display name
-- starts with \"Test\".| |lifecycleState=ACTIVE|Folders whose
-- lifecycleState is ACTIVE.| |parent=folders\/123|Folders whose parent is
-- \"folders\/123\".| |parent=folders\/123 AND lifecycleState=ACTIVE|Active
-- folders whose parent is \"folders\/123\".|
...
-- must be performed via [MoveFolders].
