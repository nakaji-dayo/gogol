...
data FoldersExclusionsCreate = FoldersExclusionsCreate'
    ...
    , _fecBearerToken :: !(Maybe Text)
    , _fecFields :: !(Maybe Text)
...
fecPp :: Lens' FoldersExclusionsCreate Bool
fecPp = lens _fecPp (\ s a -> s{_fecPp = a})
...
-- | OAuth bearer token.
fecBearerToken :: Lens' FoldersExclusionsCreate (Maybe Text)
fecBearerToken
  = lens _fecBearerToken
      (\ s a -> s{_fecBearerToken = a})

-- | Selector specifying which fields to include in a partial response.
fecFields :: Lens' FoldersExclusionsCreate (Maybe Text)
fecFields
  = lens _fecFields (\ s a -> s{_fecFields = a})
