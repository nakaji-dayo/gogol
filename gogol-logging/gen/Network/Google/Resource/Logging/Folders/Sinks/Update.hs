...
data FoldersSinksUpdate = FoldersSinksUpdate'
    ...
    , _fsuUpdateMask :: !(Maybe FieldMask)
    , _fsuPp :: !Bool
...
-- updateMask=filter.
fsuUpdateMask :: Lens' FoldersSinksUpdate (Maybe FieldMask)
fsuUpdateMask
  = lens _fsuUpdateMask
...
fsuFields :: Lens' FoldersSinksUpdate (Maybe Text)
fsuFields
  = lens _fsuFields (\ s a -> s{_fsuFields = a})
