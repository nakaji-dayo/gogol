...
data ProjectsSinksPatch = ProjectsSinksPatch'
    ...
    , _pspUpdateMask :: !(Maybe FieldMask)
    , _pspPp :: !Bool
...
-- updateMask=filter.
pspUpdateMask :: Lens' ProjectsSinksPatch (Maybe FieldMask)
pspUpdateMask
  = lens _pspUpdateMask
      (\ s a -> s{_pspUpdateMask = a})

-- | Pretty-print response.
pspPp :: Lens' ProjectsSinksPatch Bool
...
-- | OAuth bearer token.
pspBearerToken :: Lens' ProjectsSinksPatch (Maybe Text)
pspBearerToken
...
pspFields :: Lens' ProjectsSinksPatch (Maybe Text)
pspFields
