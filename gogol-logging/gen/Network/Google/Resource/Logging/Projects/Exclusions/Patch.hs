...
data ProjectsExclusionsPatch = ProjectsExclusionsPatch'
    ...
    , _pepUpdateMask :: !(Maybe FieldMask)
    , _pepPp :: !Bool
    , _pepAccessToken :: !(Maybe Text)
    , _pepUploadType :: !(Maybe Text)
    , _pepPayload :: !LogExclusion
    , _pepBearerToken :: !(Maybe Text)
    , _pepName :: !Text
    , _pepFields :: !(Maybe Text)
...
pepUpdateMask :: Lens' ProjectsExclusionsPatch (Maybe FieldMask)
pepUpdateMask
  = lens _pepUpdateMask
      (\ s a -> s{_pepUpdateMask = a})

-- | Pretty-print response.
pepPp :: Lens' ProjectsExclusionsPatch Bool
pepPp = lens _pepPp (\ s a -> s{_pepPp = a})
...
-- | OAuth bearer token.
pepBearerToken :: Lens' ProjectsExclusionsPatch (Maybe Text)
pepBearerToken
  = lens _pepBearerToken
      (\ s a -> s{_pepBearerToken = a})
...
pepFields :: Lens' ProjectsExclusionsPatch (Maybe Text)
pepFields
  = lens _pepFields (\ s a -> s{_pepFields = a})
