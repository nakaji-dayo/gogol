...
data BillingAccountsSinksPatch = BillingAccountsSinksPatch'
    ...
    , _baspBearerToken :: !(Maybe Text)
    , _baspSinkName :: !Text
    , _baspFields :: !(Maybe Text)
...
baspPp :: Lens' BillingAccountsSinksPatch Bool
baspPp = lens _baspPp (\ s a -> s{_baspPp = a})
...
-- | OAuth bearer token.
baspBearerToken :: Lens' BillingAccountsSinksPatch (Maybe Text)
baspBearerToken
  = lens _baspBearerToken
      (\ s a -> s{_baspBearerToken = a})
...
baspFields :: Lens' BillingAccountsSinksPatch (Maybe Text)
baspFields
  = lens _baspFields (\ s a -> s{_baspFields = a})
