...
baelPp :: Lens' BillingAccountsExclusionsList Bool
baelPp = lens _baelPp (\ s a -> s{_baelPp = a})
...
-- | OAuth bearer token.
baelBearerToken :: Lens' BillingAccountsExclusionsList (Maybe Text)
baelBearerToken
  = lens _baelBearerToken
      (\ s a -> s{_baelBearerToken = a})
...
baelFields :: Lens' BillingAccountsExclusionsList (Maybe Text)
baelFields
  = lens _baelFields (\ s a -> s{_baelFields = a})
