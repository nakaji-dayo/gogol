...
data BillingAccountsExclusionsPatch = BillingAccountsExclusionsPatch'
    ...
    , _baepBearerToken :: !(Maybe Text)
    , _baepName :: !Text
    , _baepFields :: !(Maybe Text)
...
baepPp :: Lens' BillingAccountsExclusionsPatch Bool
baepPp = lens _baepPp (\ s a -> s{_baepPp = a})
...
-- | OAuth bearer token.
baepBearerToken :: Lens' BillingAccountsExclusionsPatch (Maybe Text)
baepBearerToken
  = lens _baepBearerToken
      (\ s a -> s{_baepBearerToken = a})
...
baepFields :: Lens' BillingAccountsExclusionsPatch (Maybe Text)
baepFields
  = lens _baepFields (\ s a -> s{_baepFields = a})
