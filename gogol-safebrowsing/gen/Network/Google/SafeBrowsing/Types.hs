...
-- | Default request referring to version 'v4' of the Google Safe Browsing API. This contains the host and root path used as a starting point for constructing service requests.
