...
data RelyingPartyVerifyPhoneNumber = RelyingPartyVerifyPhoneNumber'
    { _rpvpnPayload :: !IdentitytoolkitRelyingPartyVerifyPhoneNumberRequest
    , _rpvpnFields :: !(Maybe Text)
...
rpvpnFields :: Lens' RelyingPartyVerifyPhoneNumber (Maybe Text)
rpvpnFields
  = lens _rpvpnFields (\ s a -> s{_rpvpnFields = a})
...
instance GoogleRequest RelyingPartyVerifyPhoneNumber
        ...
        requestClient RelyingPartyVerifyPhoneNumber'{..}
          = go _rpvpnFields (Just AltJSON) _rpvpnPayload
