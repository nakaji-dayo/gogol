...
data RelyingPartyEmailLinkSignin = RelyingPartyEmailLinkSignin'
    { _rpelsPayload :: !IdentitytoolkitRelyingPartyEmailLinkSigninRequest
    , _rpelsFields :: !(Maybe Text)
...
rpelsFields :: Lens' RelyingPartyEmailLinkSignin (Maybe Text)
rpelsFields
  = lens _rpelsFields (\ s a -> s{_rpelsFields = a})
...
instance GoogleRequest RelyingPartyEmailLinkSignin
        ...
        requestClient RelyingPartyEmailLinkSignin'{..}
          = go _rpelsFields (Just AltJSON) _rpelsPayload
