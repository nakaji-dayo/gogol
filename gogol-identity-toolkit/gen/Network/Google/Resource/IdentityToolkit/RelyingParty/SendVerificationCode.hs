...
data RelyingPartySendVerificationCode = RelyingPartySendVerificationCode'
    { _rpsvcPayload :: !IdentitytoolkitRelyingPartySendVerificationCodeRequest
    , _rpsvcFields :: !(Maybe Text)
...
rpsvcFields :: Lens' RelyingPartySendVerificationCode (Maybe Text)
rpsvcFields
  = lens _rpsvcFields (\ s a -> s{_rpsvcFields = a})
...
instance GoogleRequest
        ...
        requestClient RelyingPartySendVerificationCode'{..}
          = go _rpsvcFields (Just AltJSON) _rpsvcPayload
