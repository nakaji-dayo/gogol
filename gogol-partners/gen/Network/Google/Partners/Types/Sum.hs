...
instance Hashable ExamTokenExamType

instance FromHttpApiData ExamTokenExamType where
    parseQueryParam = \case
        ...
        x -> Left ("Unable to parse ExamTokenExamType from: " <> x)

instance ToHttpApiData ExamTokenExamType where
    toQueryParam = \case
...
instance FromJSON ExamTokenExamType where
    parseJSON = parseJSONText "ExamTokenExamType"

instance ToJSON ExamTokenExamType where
    toJSON = toJSONText
...
data ExamStatusExamType
    = ESETCertificationExamTypeUnspecified
      -- ^ @CERTIFICATION_EXAM_TYPE_UNSPECIFIED@
      -- Unchosen.
    | ESETCetAdwordsFundamentals
      -- ^ @CET_ADWORDS_FUNDAMENTALS@
      -- Adwords Fundamentals exam.
    | ESETCetAdwordsAdvancedSearch
      -- ^ @CET_ADWORDS_ADVANCED_SEARCH@
      -- AdWords advanced search exam.
    | ESETCetAdwordsAdvancedDisplay
      -- ^ @CET_ADWORDS_ADVANCED_DISPLAY@
      -- AdWords advanced display exam.
    | ESETCetVideoAds
      -- ^ @CET_VIDEO_ADS@
...
instance FromHttpApiData ExamStatusExamType where
    parseQueryParam = \case
        "CERTIFICATION_EXAM_TYPE_UNSPECIFIED" -> Right ESETCertificationExamTypeUnspecified
        "CET_ADWORDS_FUNDAMENTALS" -> Right ESETCetAdwordsFundamentals
        "CET_ADWORDS_ADVANCED_SEARCH" -> Right ESETCetAdwordsAdvancedSearch
        "CET_ADWORDS_ADVANCED_DISPLAY" -> Right ESETCetAdwordsAdvancedDisplay
        "CET_VIDEO_ADS" -> Right ESETCetVideoAds
        "CET_DOUBLECLICK" -> Right ESETCetDoubleClick
        "CET_ANALYTICS" -> Right ESETCetAnalytics
        "CET_SHOPPING" -> Right ESETCetShopping
        "CET_MOBILE" -> Right ESETCetMobile
        "CET_DIGITAL_SALES" -> Right ESETCetDigitalSales
        "CET_MOBILE_SITES" -> Right ESETCetMobileSites
        x -> Left ("Unable to parse ExamStatusExamType from: " <> x)

instance ToHttpApiData ExamStatusExamType where
    toQueryParam = \case
        ESETCertificationExamTypeUnspecified -> "CERTIFICATION_EXAM_TYPE_UNSPECIFIED"
        ESETCetAdwordsFundamentals -> "CET_ADWORDS_FUNDAMENTALS"
        ESETCetAdwordsAdvancedSearch -> "CET_ADWORDS_ADVANCED_SEARCH"
        ESETCetAdwordsAdvancedDisplay -> "CET_ADWORDS_ADVANCED_DISPLAY"
        ESETCetVideoAds -> "CET_VIDEO_ADS"
        ESETCetDoubleClick -> "CET_DOUBLECLICK"
        ESETCetAnalytics -> "CET_ANALYTICS"
        ESETCetShopping -> "CET_SHOPPING"
        ESETCetMobile -> "CET_MOBILE"
        ESETCetDigitalSales -> "CET_DIGITAL_SALES"
        ESETCetMobileSites -> "CET_MOBILE_SITES"
