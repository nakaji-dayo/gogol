...
udcrPp :: Lens' UsersDeleteCompanyRelation Bool
udcrPp = lens _udcrPp (\ s a -> s{_udcrPp = a})
...
-- | OAuth bearer token.
udcrBearerToken :: Lens' UsersDeleteCompanyRelation (Maybe Text)
udcrBearerToken
  = lens _udcrBearerToken
      (\ s a -> s{_udcrBearerToken = a})
...
udcrFields :: Lens' UsersDeleteCompanyRelation (Maybe Text)
udcrFields
  = lens _udcrFields (\ s a -> s{_udcrFields = a})
