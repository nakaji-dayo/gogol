...
uccrPp :: Lens' UsersCreateCompanyRelation Bool
uccrPp = lens _uccrPp (\ s a -> s{_uccrPp = a})
...
-- | OAuth bearer token.
uccrBearerToken :: Lens' UsersCreateCompanyRelation (Maybe Text)
uccrBearerToken
  = lens _uccrBearerToken
      (\ s a -> s{_uccrBearerToken = a})
...
uccrFields :: Lens' UsersCreateCompanyRelation (Maybe Text)
uccrFields
  = lens _uccrFields (\ s a -> s{_uccrFields = a})
