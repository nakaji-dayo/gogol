...
--
-- /See:/ <https://developers.google.com/beacons/proximity/ Google Proximity Beacon API Reference> for @proximitybeacon.beacons.delete@.
module Network.Google.Resource.ProximityBeacon.Beacons.Delete
    (
    -- * REST Resource
...
-- | OAuth bearer token.
bBearerToken :: Lens' BeaconsDelete (Maybe Text)
bBearerToken
...
bFields :: Lens' BeaconsDelete (Maybe Text)
