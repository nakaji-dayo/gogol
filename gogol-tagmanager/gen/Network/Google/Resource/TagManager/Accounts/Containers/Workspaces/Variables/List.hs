...
acwvlFields :: Lens' AccountsContainersWorkspacesVariablesList (Maybe Text)
acwvlFields
  = lens _acwvlFields (\ s a -> s{_acwvlFields = a})
...
instance GoogleRequest
        ...
        requestClient
          AccountsContainersWorkspacesVariablesList'{..}
          = go _acwvlParent _acwvlPageToken _acwvlFields
              (Just AltJSON)
              tagManagerService
          where go
                  = buildClient
