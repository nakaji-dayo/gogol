...
data AccountsContainersWorkspacesQuickPreview = AccountsContainersWorkspacesQuickPreview'
    { _acwqpPath :: !Text
    , _acwqpFields :: !(Maybe Text)
...
acwqpFields :: Lens' AccountsContainersWorkspacesQuickPreview (Maybe Text)
acwqpFields
  = lens _acwqpFields (\ s a -> s{_acwqpFields = a})
...
instance GoogleRequest
        ...
        requestClient
          AccountsContainersWorkspacesQuickPreview'{..}
          = go _acwqpPath _acwqpFields (Just AltJSON)
              tagManagerService
          where go
                  = buildClient
                      (Proxy ::
