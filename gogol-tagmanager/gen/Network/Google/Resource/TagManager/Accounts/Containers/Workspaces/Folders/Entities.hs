...
acwfeFields :: Lens' AccountsContainersWorkspacesFoldersEntities (Maybe Text)
acwfeFields
  = lens _acwfeFields (\ s a -> s{_acwfeFields = a})
...
instance GoogleRequest
        ...
        requestClient
          AccountsContainersWorkspacesFoldersEntities'{..}
          = go _acwfePath _acwfePageToken _acwfeFields
              (Just AltJSON)
              tagManagerService
          where go
                  = buildClient
