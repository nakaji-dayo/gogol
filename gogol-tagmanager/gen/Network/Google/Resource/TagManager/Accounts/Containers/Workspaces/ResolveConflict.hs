...
acwrcFields :: Lens' AccountsContainersWorkspacesResolveConflict (Maybe Text)
acwrcFields
  = lens _acwrcFields (\ s a -> s{_acwrcFields = a})
...
instance GoogleRequest
        ...
        requestClient
          AccountsContainersWorkspacesResolveConflict'{..}
          = go _acwrcPath _acwrcFingerprint _acwrcFields
              (Just AltJSON)
              _acwrcPayload
              tagManagerService
          where go
