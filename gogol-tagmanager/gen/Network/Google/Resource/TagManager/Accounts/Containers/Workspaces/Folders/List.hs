...
acwflFields :: Lens' AccountsContainersWorkspacesFoldersList (Maybe Text)
acwflFields
  = lens _acwflFields (\ s a -> s{_acwflFields = a})
...
instance GoogleRequest
        ...
        requestClient
          AccountsContainersWorkspacesFoldersList'{..}
          = go _acwflParent _acwflPageToken _acwflFields
              (Just AltJSON)
              tagManagerService
          where go
                  = buildClient
