...
acwupFields :: Lens' AccountsContainersWorkspacesUpdateProposal (Maybe Text)
acwupFields
  = lens _acwupFields (\ s a -> s{_acwupFields = a})
...
instance GoogleRequest
        ...
        requestClient
          AccountsContainersWorkspacesUpdateProposal'{..}
          = go _acwupPath _acwupFields (Just AltJSON)
              _acwupPayload
              tagManagerService
          where go
                  = buildClient
