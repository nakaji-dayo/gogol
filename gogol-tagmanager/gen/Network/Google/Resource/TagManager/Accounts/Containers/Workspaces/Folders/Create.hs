...
acwfcFields :: Lens' AccountsContainersWorkspacesFoldersCreate (Maybe Text)
acwfcFields
  = lens _acwfcFields (\ s a -> s{_acwfcFields = a})
...
instance GoogleRequest
        ...
        requestClient
          AccountsContainersWorkspacesFoldersCreate'{..}
          = go _acwfcParent _acwfcFields (Just AltJSON)
              _acwfcPayload
              tagManagerService
          where go
                  = buildClient
