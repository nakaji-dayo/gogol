...
data AccountsContainersWorkspacesTriggersDelete = AccountsContainersWorkspacesTriggersDelete'
    { _acwtdPath :: !Text
    , _acwtdFields :: !(Maybe Text)
...
acwtdFields :: Lens' AccountsContainersWorkspacesTriggersDelete (Maybe Text)
acwtdFields
  = lens _acwtdFields (\ s a -> s{_acwtdFields = a})
...
instance GoogleRequest
        ...
        requestClient
          AccountsContainersWorkspacesTriggersDelete'{..}
          = go _acwtdPath _acwtdFields (Just AltJSON)
              tagManagerService
          where go
                  = buildClient
                      (Proxy ::
