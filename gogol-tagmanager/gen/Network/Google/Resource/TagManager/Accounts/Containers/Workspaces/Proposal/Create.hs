...
acwpcFields :: Lens' AccountsContainersWorkspacesProposalCreate (Maybe Text)
acwpcFields
  = lens _acwpcFields (\ s a -> s{_acwpcFields = a})
...
instance GoogleRequest
        ...
        requestClient
          AccountsContainersWorkspacesProposalCreate'{..}
          = go _acwpcParent _acwpcFields (Just AltJSON)
              _acwpcPayload
              tagManagerService
          where go
                  = buildClient
