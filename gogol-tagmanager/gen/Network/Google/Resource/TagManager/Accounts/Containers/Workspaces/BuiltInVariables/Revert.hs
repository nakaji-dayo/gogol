...
acwbivrFields :: Lens' AccountsContainersWorkspacesBuiltInVariablesRevert (Maybe Text)
acwbivrFields
  = lens _acwbivrFields
      (\ s a -> s{_acwbivrFields = a})
...
instance GoogleRequest
        ...
        requestClient
          AccountsContainersWorkspacesBuiltInVariablesRevert'{..}
          = go _acwbivrPath _acwbivrType _acwbivrFields
              (Just AltJSON)
              tagManagerService
          where go
                  = buildClient
