...
acwfuFields :: Lens' AccountsContainersWorkspacesFoldersUpdate (Maybe Text)
acwfuFields
  = lens _acwfuFields (\ s a -> s{_acwfuFields = a})
...
instance GoogleRequest
        ...
        requestClient
          AccountsContainersWorkspacesFoldersUpdate'{..}
          = go _acwfuPath _acwfuFingerprint _acwfuFields
              (Just AltJSON)
              _acwfuPayload
              tagManagerService
          where go
