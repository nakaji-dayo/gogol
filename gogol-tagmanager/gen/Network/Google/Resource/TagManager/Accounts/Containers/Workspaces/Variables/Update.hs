...
acwvuFields :: Lens' AccountsContainersWorkspacesVariablesUpdate (Maybe Text)
acwvuFields
  = lens _acwvuFields (\ s a -> s{_acwvuFields = a})
...
instance GoogleRequest
        ...
        requestClient
          AccountsContainersWorkspacesVariablesUpdate'{..}
          = go _acwvuPath _acwvuFingerprint _acwvuFields
              (Just AltJSON)
              _acwvuPayload
              tagManagerService
          where go
