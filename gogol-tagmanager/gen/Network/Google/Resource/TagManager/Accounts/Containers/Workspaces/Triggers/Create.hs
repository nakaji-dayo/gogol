...
data AccountsContainersWorkspacesTriggersCreate = AccountsContainersWorkspacesTriggersCreate'
    { _acwtcParent :: !Text
    , _acwtcPayload :: !Trigger
    , _acwtcFields :: !(Maybe Text)
...
acwtcFields :: Lens' AccountsContainersWorkspacesTriggersCreate (Maybe Text)
acwtcFields
  = lens _acwtcFields (\ s a -> s{_acwtcFields = a})

instance GoogleRequest
         AccountsContainersWorkspacesTriggersCreate where
        ...
        requestClient
          AccountsContainersWorkspacesTriggersCreate'{..}
          = go _acwtcParent _acwtcFields (Just AltJSON)
              _acwtcPayload
              tagManagerService
          where go
                  = buildClient
