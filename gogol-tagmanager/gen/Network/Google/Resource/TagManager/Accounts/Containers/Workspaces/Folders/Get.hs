...
data AccountsContainersWorkspacesFoldersGet = AccountsContainersWorkspacesFoldersGet'
    { _acwfgPath :: !Text
    , _acwfgFields :: !(Maybe Text)
...
acwfgFields :: Lens' AccountsContainersWorkspacesFoldersGet (Maybe Text)
acwfgFields
  = lens _acwfgFields (\ s a -> s{_acwfgFields = a})
...
instance GoogleRequest
        ...
        requestClient
          AccountsContainersWorkspacesFoldersGet'{..}
          = go _acwfgPath _acwfgFields (Just AltJSON)
              tagManagerService
          where go
                  = buildClient
                      (Proxy ::
