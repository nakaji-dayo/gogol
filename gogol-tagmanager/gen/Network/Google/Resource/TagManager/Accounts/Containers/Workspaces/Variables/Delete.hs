...
data AccountsContainersWorkspacesVariablesDelete = AccountsContainersWorkspacesVariablesDelete'
    { _acwvdPath :: !Text
    , _acwvdFields :: !(Maybe Text)
...
acwvdFields :: Lens' AccountsContainersWorkspacesVariablesDelete (Maybe Text)
acwvdFields
  = lens _acwvdFields (\ s a -> s{_acwvdFields = a})
...
instance GoogleRequest
        ...
        requestClient
          AccountsContainersWorkspacesVariablesDelete'{..}
          = go _acwvdPath _acwvdFields (Just AltJSON)
              tagManagerService
          where go
                  = buildClient
                      (Proxy ::
