...
acwtrFields :: Lens' AccountsContainersWorkspacesTriggersRevert (Maybe Text)
acwtrFields
  = lens _acwtrFields (\ s a -> s{_acwtrFields = a})
...
instance GoogleRequest
        ...
        requestClient
          AccountsContainersWorkspacesTriggersRevert'{..}
          = go _acwtrPath _acwtrFingerprint _acwtrFields
              (Just AltJSON)
              tagManagerService
          where go
                  = buildClient
