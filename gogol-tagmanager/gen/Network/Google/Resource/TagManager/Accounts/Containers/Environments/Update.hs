...
aceuFields :: Lens' AccountsContainersEnvironmentsUpdate (Maybe Text)
aceuFields
  = lens _aceuFields (\ s a -> s{_aceuFields = a})
...
instance GoogleRequest
        ...
        requestClient
          AccountsContainersEnvironmentsUpdate'{..}
          = go _aceuPath _aceuFingerprint _aceuFields
              (Just AltJSON)
              _aceuPayload
              tagManagerService
          where go
