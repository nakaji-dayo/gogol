...
acwcFields :: Lens' AccountsContainersWorkspacesCreate (Maybe Text)
acwcFields
  = lens _acwcFields (\ s a -> s{_acwcFields = a})
...
instance GoogleRequest
        ...
        requestClient AccountsContainersWorkspacesCreate'{..}
          = go _acwcParent _acwcFields (Just AltJSON)
              _acwcPayload
              tagManagerService
          where go
                  = buildClient
