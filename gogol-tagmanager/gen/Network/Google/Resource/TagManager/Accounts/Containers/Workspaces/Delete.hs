...
data AccountsContainersWorkspacesDelete = AccountsContainersWorkspacesDelete'
    { _acwdPath :: !Text
    , _acwdFields :: !(Maybe Text)
...
acwdFields :: Lens' AccountsContainersWorkspacesDelete (Maybe Text)
acwdFields
  = lens _acwdFields (\ s a -> s{_acwdFields = a})
...
instance GoogleRequest
        ...
        requestClient AccountsContainersWorkspacesDelete'{..}
          = go _acwdPath _acwdFields (Just AltJSON)
              tagManagerService
          where go
                  = buildClient
                      (Proxy ::
