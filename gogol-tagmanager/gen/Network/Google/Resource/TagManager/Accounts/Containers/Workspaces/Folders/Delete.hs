...
data AccountsContainersWorkspacesFoldersDelete = AccountsContainersWorkspacesFoldersDelete'
    { _acwfdPath :: !Text
    , _acwfdFields :: !(Maybe Text)
...
acwfdFields :: Lens' AccountsContainersWorkspacesFoldersDelete (Maybe Text)
acwfdFields
  = lens _acwfdFields (\ s a -> s{_acwfdFields = a})
...
instance GoogleRequest
        ...
        requestClient
          AccountsContainersWorkspacesFoldersDelete'{..}
          = go _acwfdPath _acwfdFields (Just AltJSON)
              tagManagerService
          where go
                  = buildClient
                      (Proxy ::
