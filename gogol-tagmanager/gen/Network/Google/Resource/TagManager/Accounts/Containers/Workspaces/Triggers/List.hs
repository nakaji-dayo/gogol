...
acwtlcFields :: Lens' AccountsContainersWorkspacesTriggersList (Maybe Text)
acwtlcFields
  = lens _acwtlcFields (\ s a -> s{_acwtlcFields = a})
...
instance GoogleRequest
        ...
        requestClient
          AccountsContainersWorkspacesTriggersList'{..}
          = go _acwtlcParent _acwtlcPageToken _acwtlcFields
              (Just AltJSON)
              tagManagerService
          where go
                  = buildClient
