...
acwfmetfFields :: Lens' AccountsContainersWorkspacesFoldersMoveEntitiesToFolder (Maybe Text)
acwfmetfFields
  = lens _acwfmetfFields
      (\ s a -> s{_acwfmetfFields = a})
