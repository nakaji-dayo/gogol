...
acwbivlFields :: Lens' AccountsContainersWorkspacesBuiltInVariablesList (Maybe Text)
acwbivlFields
  = lens _acwbivlFields
      (\ s a -> s{_acwbivlFields = a})
...
instance GoogleRequest
        ...
        requestClient
          AccountsContainersWorkspacesBuiltInVariablesList'{..}
          = go _acwbivlParent _acwbivlPageToken _acwbivlFields
              (Just AltJSON)
              tagManagerService
          where go
                  = buildClient
