...
acwtuFields :: Lens' AccountsContainersWorkspacesTriggersUpdate (Maybe Text)
acwtuFields
  = lens _acwtuFields (\ s a -> s{_acwtuFields = a})
...
instance GoogleRequest
        ...
        requestClient
          AccountsContainersWorkspacesTriggersUpdate'{..}
          = go _acwtuPath _acwtuFingerprint _acwtuFields
              (Just AltJSON)
              _acwtuPayload
              tagManagerService
          where go
