...
acwcvFields :: Lens' AccountsContainersWorkspacesCreateVersion (Maybe Text)
acwcvFields
  = lens _acwcvFields (\ s a -> s{_acwcvFields = a})
...
instance GoogleRequest
        ...
        requestClient
          AccountsContainersWorkspacesCreateVersion'{..}
          = go _acwcvPath _acwcvFields (Just AltJSON)
              _acwcvPayload
              tagManagerService
          where go
                  = buildClient
