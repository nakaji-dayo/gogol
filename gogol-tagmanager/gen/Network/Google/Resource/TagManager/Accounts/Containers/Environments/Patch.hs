...
acepFields :: Lens' AccountsContainersEnvironmentsPatch (Maybe Text)
acepFields
  = lens _acepFields (\ s a -> s{_acepFields = a})
...
instance GoogleRequest
        ...
        requestClient
          AccountsContainersEnvironmentsPatch'{..}
          = go _acepPath _acepFingerprint _acepFields
              (Just AltJSON)
              _acepPayload
              tagManagerService
          where go
