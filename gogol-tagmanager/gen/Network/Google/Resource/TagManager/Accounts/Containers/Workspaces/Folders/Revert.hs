...
acwfrFields :: Lens' AccountsContainersWorkspacesFoldersRevert (Maybe Text)
acwfrFields
  = lens _acwfrFields (\ s a -> s{_acwfrFields = a})
...
instance GoogleRequest
        ...
        requestClient
          AccountsContainersWorkspacesFoldersRevert'{..}
          = go _acwfrPath _acwfrFingerprint _acwfrFields
              (Just AltJSON)
              tagManagerService
          where go
                  = buildClient
