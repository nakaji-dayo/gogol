...
acwvcFields :: Lens' AccountsContainersWorkspacesVariablesCreate (Maybe Text)
acwvcFields
  = lens _acwvcFields (\ s a -> s{_acwvcFields = a})
...
instance GoogleRequest
        ...
        requestClient
          AccountsContainersWorkspacesVariablesCreate'{..}
          = go _acwvcParent _acwvcFields (Just AltJSON)
              _acwvcPayload
              tagManagerService
          where go
                  = buildClient
