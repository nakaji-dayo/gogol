...
-- status of the recreating action with the listmanagedinstances method. If
...
rigmriFields :: Lens' RegionInstanceGroupManagersRecreateInstances (Maybe Text)
rigmriFields
  = lens _rigmriFields (\ s a -> s{_rigmriFields = a})
