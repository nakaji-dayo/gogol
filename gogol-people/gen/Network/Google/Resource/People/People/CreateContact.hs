...
--
-- /See:/ <https://developers.google.com/people/ Google People API Reference> for @people.people.createContact@.
module Network.Google.Resource.People.People.CreateContact
    (
    -- * REST Resource
...
pccPp :: Lens' PeopleCreateContact Bool
...
-- | OAuth bearer token.
pccBearerToken :: Lens' PeopleCreateContact (Maybe Text)
pccBearerToken
  = lens _pccBearerToken
      (\ s a -> s{_pccBearerToken = a})

-- | Selector specifying which fields to include in a partial response.
pccFields :: Lens' PeopleCreateContact (Maybe Text)
pccFields
  = lens _pccFields (\ s a -> s{_pccFields = a})
