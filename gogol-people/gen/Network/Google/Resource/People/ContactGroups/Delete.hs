...
--
-- /See:/ <https://developers.google.com/people/ Google People API Reference> for @people.contactGroups.delete@.
module Network.Google.Resource.People.ContactGroups.Delete
    (
    -- * REST Resource
...
data ContactGroupsDelete = ContactGroupsDelete'
    ...
    , _cgdBearerToken :: !(Maybe Text)
    , _cgdFields :: !(Maybe Text)
...
cgdPp :: Lens' ContactGroupsDelete Bool
cgdPp = lens _cgdPp (\ s a -> s{_cgdPp = a})
...
-- | OAuth bearer token.
cgdBearerToken :: Lens' ContactGroupsDelete (Maybe Text)
cgdBearerToken
  = lens _cgdBearerToken
      (\ s a -> s{_cgdBearerToken = a})

-- | Selector specifying which fields to include in a partial response.
cgdFields :: Lens' ContactGroupsDelete (Maybe Text)
cgdFields
  = lens _cgdFields (\ s a -> s{_cgdFields = a})
