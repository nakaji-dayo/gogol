...
--
-- /See:/ <https://cloud.google.com/natural-language/ Google Cloud Natural Language API Reference> for @language.documents.classifyText@.
module Network.Google.Resource.Language.Documents.ClassifyText
    (
    -- * REST Resource
...
data DocumentsClassifyText = DocumentsClassifyText'
    ...
    , _dctBearerToken :: !(Maybe Text)
    , _dctFields :: !(Maybe Text)
...
dctPp :: Lens' DocumentsClassifyText Bool
dctPp = lens _dctPp (\ s a -> s{_dctPp = a})
...
-- | OAuth bearer token.
dctBearerToken :: Lens' DocumentsClassifyText (Maybe Text)
dctBearerToken
  = lens _dctBearerToken
      (\ s a -> s{_dctBearerToken = a})

-- | Selector specifying which fields to include in a partial response.
dctFields :: Lens' DocumentsClassifyText (Maybe Text)
dctFields
  = lens _dctFields (\ s a -> s{_dctFields = a})
...
instance GoogleRequest DocumentsClassifyText where
        ...
        requestClient DocumentsClassifyText'{..}
          = go _dctXgafv _dctUploadProtocol (Just _dctPp)
              _dctAccessToken
              _dctUploadType
              _dctBearerToken
              _dctCallback
