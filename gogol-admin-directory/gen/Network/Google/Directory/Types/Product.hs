...
-- | The type of the calendar resource, intended for non-room resources. The
-- type of the calendar resource. Used for grouping resources in the
...
-- | Description of the resource, visible only to admins. The brief
