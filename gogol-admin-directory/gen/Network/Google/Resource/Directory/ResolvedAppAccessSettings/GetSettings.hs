...
newtype ResolvedAppAccessSettingsGetSettings = ResolvedAppAccessSettingsGetSettings'
    { _raasgsFields :: Maybe Text
...
resolvedAppAccessSettingsGetSettings = 
    ResolvedAppAccessSettingsGetSettings'
    { _raasgsFields = Nothing
    }

-- | Selector specifying which fields to include in a partial response.
raasgsFields :: Lens' ResolvedAppAccessSettingsGetSettings (Maybe Text)
raasgsFields
  = lens _raasgsFields (\ s a -> s{_raasgsFields = a})
...
instance GoogleRequest
        ...
        requestClient
          ResolvedAppAccessSettingsGetSettings'{..}
          = go _raasgsFields (Just AltJSON) directoryService
          where go
                  = buildClient
                      (Proxy ::
