...
data PresentationsPagesGetThumbnail = PresentationsPagesGetThumbnail'
    ...
    , _ppgtBearerToken :: !(Maybe Text)
    , _ppgtFields :: !(Maybe Text)
...
ppgtPp :: Lens' PresentationsPagesGetThumbnail Bool
ppgtPp = lens _ppgtPp (\ s a -> s{_ppgtPp = a})
...
-- | OAuth bearer token.
ppgtBearerToken :: Lens' PresentationsPagesGetThumbnail (Maybe Text)
ppgtBearerToken
  = lens _ppgtBearerToken
      (\ s a -> s{_ppgtBearerToken = a})

-- | Selector specifying which fields to include in a partial response.
ppgtFields :: Lens' PresentationsPagesGetThumbnail (Maybe Text)
ppgtFields
  = lens _ppgtFields (\ s a -> s{_ppgtFields = a})
