...
--
-- /See:/ <https://cloud.google.com/container-engine/ Google Container Engine API Reference> for @container.projects.zones.clusters.setMaintenancePolicy@.
module Network.Google.Resource.Container.Projects.Zones.Clusters.SetMaintenancePolicy
    (
    -- * REST Resource
...
data ProjectsZonesClustersSetMaintenancePolicy = ProjectsZonesClustersSetMaintenancePolicy'
    ...
    , _pzcsmpBearerToken :: !(Maybe Text)
    , _pzcsmpClusterId :: !Text
    , _pzcsmpProjectId :: !Text
    , _pzcsmpFields :: !(Maybe Text)
...
pzcsmpPp :: Lens' ProjectsZonesClustersSetMaintenancePolicy Bool
pzcsmpPp = lens _pzcsmpPp (\ s a -> s{_pzcsmpPp = a})
...
-- | OAuth bearer token.
pzcsmpBearerToken :: Lens' ProjectsZonesClustersSetMaintenancePolicy (Maybe Text)
pzcsmpBearerToken
  = lens _pzcsmpBearerToken
      (\ s a -> s{_pzcsmpBearerToken = a})
...
pzcsmpFields :: Lens' ProjectsZonesClustersSetMaintenancePolicy (Maybe Text)
pzcsmpFields
  = lens _pzcsmpFields (\ s a -> s{_pzcsmpFields = a})
