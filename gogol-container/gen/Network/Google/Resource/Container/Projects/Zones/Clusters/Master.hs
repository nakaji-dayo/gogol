...
--
-- /See:/ <https://cloud.google.com/container-engine/ Google Container Engine API Reference> for @container.projects.zones.clusters.master@.
module Network.Google.Resource.Container.Projects.Zones.Clusters.Master
    (
    -- * REST Resource
...
data ProjectsZonesClustersMaster = ProjectsZonesClustersMaster'
    ...
    , _pzcmBearerToken :: !(Maybe Text)
    , _pzcmClusterId :: !Text
    , _pzcmProjectId :: !Text
    , _pzcmFields :: !(Maybe Text)
...
pzcmPp :: Lens' ProjectsZonesClustersMaster Bool
pzcmPp = lens _pzcmPp (\ s a -> s{_pzcmPp = a})
...
-- | OAuth bearer token.
pzcmBearerToken :: Lens' ProjectsZonesClustersMaster (Maybe Text)
pzcmBearerToken
  = lens _pzcmBearerToken
      (\ s a -> s{_pzcmBearerToken = a})
...
pzcmFields :: Lens' ProjectsZonesClustersMaster (Maybe Text)
pzcmFields
  = lens _pzcmFields (\ s a -> s{_pzcmFields = a})
