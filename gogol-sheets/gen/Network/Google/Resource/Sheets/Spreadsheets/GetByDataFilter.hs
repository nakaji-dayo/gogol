...
data SpreadsheetsGetByDataFilter = SpreadsheetsGetByDataFilter'
    ...
    , _sgbdfBearerToken :: !(Maybe Text)
    , _sgbdfFields :: !(Maybe Text)
...
spreadsheetsGetByDataFilter pSgbdfSpreadsheetId_ pSgbdfPayload_ = 
    ...
    , _sgbdfBearerToken = Nothing
    , _sgbdfFields = Nothing
...
sgbdfPp :: Lens' SpreadsheetsGetByDataFilter Bool
sgbdfPp = lens _sgbdfPp (\ s a -> s{_sgbdfPp = a})
...
-- | OAuth bearer token.
sgbdfBearerToken :: Lens' SpreadsheetsGetByDataFilter (Maybe Text)
sgbdfBearerToken
  = lens _sgbdfBearerToken
      (\ s a -> s{_sgbdfBearerToken = a})

-- | Selector specifying which fields to include in a partial response.
sgbdfFields :: Lens' SpreadsheetsGetByDataFilter (Maybe Text)
sgbdfFields
  = lens _sgbdfFields (\ s a -> s{_sgbdfFields = a})
