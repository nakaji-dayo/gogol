...
data SpreadsheetsValuesBatchClearByDataFilter = SpreadsheetsValuesBatchClearByDataFilter'
    ...
    , _svbcbdfBearerToken :: !(Maybe Text)
    , _svbcbdfFields :: !(Maybe Text)
...
spreadsheetsValuesBatchClearByDataFilter pSvbcbdfSpreadsheetId_ pSvbcbdfPayload_ = 
    ...
    , _svbcbdfBearerToken = Nothing
    , _svbcbdfFields = Nothing
...
svbcbdfPp :: Lens' SpreadsheetsValuesBatchClearByDataFilter Bool
svbcbdfPp
  = lens _svbcbdfPp (\ s a -> s{_svbcbdfPp = a})
...
-- | OAuth bearer token.
svbcbdfBearerToken :: Lens' SpreadsheetsValuesBatchClearByDataFilter (Maybe Text)
svbcbdfBearerToken
  = lens _svbcbdfBearerToken
      (\ s a -> s{_svbcbdfBearerToken = a})

-- | Selector specifying which fields to include in a partial response.
svbcbdfFields :: Lens' SpreadsheetsValuesBatchClearByDataFilter (Maybe Text)
svbcbdfFields
  = lens _svbcbdfFields
      (\ s a -> s{_svbcbdfFields = a})
