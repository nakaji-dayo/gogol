...
data SpreadsheetsDeveloperMetadataSearch = SpreadsheetsDeveloperMetadataSearch'
    ...
    , _sdmsBearerToken :: !(Maybe Text)
    , _sdmsFields :: !(Maybe Text)
...
sdmsPp :: Lens' SpreadsheetsDeveloperMetadataSearch Bool
sdmsPp = lens _sdmsPp (\ s a -> s{_sdmsPp = a})
...
-- | OAuth bearer token.
sdmsBearerToken :: Lens' SpreadsheetsDeveloperMetadataSearch (Maybe Text)
sdmsBearerToken
  = lens _sdmsBearerToken
      (\ s a -> s{_sdmsBearerToken = a})

-- | Selector specifying which fields to include in a partial response.
sdmsFields :: Lens' SpreadsheetsDeveloperMetadataSearch (Maybe Text)
sdmsFields
  = lens _sdmsFields (\ s a -> s{_sdmsFields = a})
