...
data ProjectsServiceAccountGet = ProjectsServiceAccountGet'
...
psagFields :: Lens' ProjectsServiceAccountGet (Maybe Text)
psagFields
...
instance GoogleRequest ProjectsServiceAccountGet
        ...
        requestClient ProjectsServiceAccountGet'{..}
          = go _psagProjectId _psagUserProject _psagFields
              (Just AltJSON)
              storageService
          where go
                  = buildClient
