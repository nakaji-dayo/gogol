...
-- warning.
--
-- /See:/ <https://cloud.google.com/ml/ Google Cloud Machine Learning Engine Reference> for @ml.projects.models.testIamPermissions@.
module Network.Google.Resource.Ml.Projects.Models.TestIAMPermissions
    (
    -- * REST Resource
...
data ProjectsModelsTestIAMPermissions = ProjectsModelsTestIAMPermissions'
    ...
    , _pmtipBearerToken :: !(Maybe Text)
    , _pmtipResource :: !Text
    , _pmtipFields :: !(Maybe Text)
...
projectsModelsTestIAMPermissions pPmtipPayload_ pPmtipResource_ = 
    ...
    , _pmtipBearerToken = Nothing
    , _pmtipResource = pPmtipResource_
    , _pmtipFields = Nothing
...
pmtipPp :: Lens' ProjectsModelsTestIAMPermissions Bool
pmtipPp = lens _pmtipPp (\ s a -> s{_pmtipPp = a})
...
-- | OAuth bearer token.
pmtipBearerToken :: Lens' ProjectsModelsTestIAMPermissions (Maybe Text)
pmtipBearerToken
  = lens _pmtipBearerToken
      (\ s a -> s{_pmtipBearerToken = a})
...
pmtipFields :: Lens' ProjectsModelsTestIAMPermissions (Maybe Text)
pmtipFields
  = lens _pmtipFields (\ s a -> s{_pmtipFields = a})
