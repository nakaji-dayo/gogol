...
--
-- /See:/ <https://cloud.google.com/ml/ Google Cloud Machine Learning Engine Reference> for @ml.projects.jobs.getIamPolicy@.
module Network.Google.Resource.Ml.Projects.Jobs.GetIAMPolicy
    (
    -- * REST Resource
...
data ProjectsJobsGetIAMPolicy = ProjectsJobsGetIAMPolicy'
    ...
    , _pjgipBearerToken :: !(Maybe Text)
    , _pjgipResource :: !Text
    , _pjgipFields :: !(Maybe Text)
...
projectsJobsGetIAMPolicy pPjgipResource_ = 
    ...
    , _pjgipBearerToken = Nothing
    , _pjgipResource = pPjgipResource_
    , _pjgipFields = Nothing
...
pjgipPp :: Lens' ProjectsJobsGetIAMPolicy Bool
pjgipPp = lens _pjgipPp (\ s a -> s{_pjgipPp = a})
...
-- | OAuth bearer token.
pjgipBearerToken :: Lens' ProjectsJobsGetIAMPolicy (Maybe Text)
pjgipBearerToken
  = lens _pjgipBearerToken
      (\ s a -> s{_pjgipBearerToken = a})
...
pjgipFields :: Lens' ProjectsJobsGetIAMPolicy (Maybe Text)
pjgipFields
  = lens _pjgipFields (\ s a -> s{_pjgipFields = a})
